...
export function EightLogo(props: HTMLAttributes<SVGElement>) {
    return (
        <svg {...props} width="85" height="85" viewBox="0 0 85 85" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 7C0 3.13401 3.13401 0 7 0H78C81.866 0 85 3.13401 85 7V78C85 81.866 81.866 85 78 85H7C3.13401 85 0 81.866 0 78V7Z" fill="black" />
            <path d="M36.3043 33.7713H48.6957V51.2287H36.3043V33.7713Z" fill="white" />
