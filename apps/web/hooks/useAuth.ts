import type { ForgotPasswordFormData, ResetPasswordFormData, SignInFormData, SignUpFormData } from "@/schemas/index";
import { authClient } from "@eight/auth/auth-client";
